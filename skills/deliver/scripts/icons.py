...
# -*- coding: utf-8 -*-
"""
icons.py — instala los iconos del catálogo en un proyecto, por plataforma.

    python3 icons.py --destino <proyecto> --plataforma web
    python3 icons.py --destino <proyecto> --plataforma web --solo buscar,cerrar
    python3 icons.py --destino <proyecto> --plataforma ios --listar
    python3 icons.py --catalogo                       qué acciones hay declaradas
...
def main():
    ...
    if salida:
        print(f"En {salida}")
        print("\nComprobalos con:  deliver.py --destino <proyecto> --regla DS-F10")
