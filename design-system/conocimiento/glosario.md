...
plantillas y páginas. **Esta doctrina no la usa**; usa la alternativa de cuatro niveles. Ver `03-components` §3.2.
...
**Colección** *(collection)* — Grupo de variables de Figma que comparten propósito y modos. Esta doctrina usa seis.
...
**Estilo** *(style)* — Conjunto de propiedades visuales guardado con nombre. En la arquitectura de esta doctrina los
...
A, AA y AAA. **El objetivo es AA**, con AAA en lo crítico.
