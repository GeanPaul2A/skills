...
el contrato de máquina; `documentar` produce el contrato **para quien lo usa**: qué hace, cuándo usarlo, cuándo
...
| `${CLAUDE_PLUGIN_ROOT}/conocimiento/componentes.md` | El contrato del inventario, campo por campo |
| `${CLAUDE_PLUGIN_ROOT}/conocimiento/accesibilidad.md` | Rol, teclado, lector de pantalla, contraste |
