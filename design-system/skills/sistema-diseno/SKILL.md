...
condiciones de entrada. `${CLAUDE_PLUGIN_ROOT}/conocimiento/accesibilidad.md`.
...
Valida contra `${CLAUDE_SKILL_DIR}/esquemas/inventario.schema.json`. El detalle del contrato, en `${CLAUDE_PLUGIN_ROOT}/conocimiento/componentes.md`.
...
3. **Dilo antes de intentarlo.** Si solo lee, no prometas dibujar: entrega el documento de lienzo y las
...
| `${CLAUDE_PLUGIN_ROOT}/conocimiento/componentes.md` | Al declarar o revisar un componente |
| `${CLAUDE_PLUGIN_ROOT}/conocimiento/accesibilidad.md` | Al elegir color, al declarar estados, antes de entregar |
| `${CLAUDE_PLUGIN_ROOT}/conocimiento/doctrina.md` | **Las 76 reglas `DS-xxx` con su origen.** Consulta puntual: cuando haya que justificar algo, o al agregar una regla |
...
| **Estados olvidados** | Un componente sin `foco`, sin `cargando` | Ver `${CLAUDE_PLUGIN_ROOT}/conocimiento/componentes.md` |
